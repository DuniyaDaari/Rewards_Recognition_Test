...
import java.util.Vector;
    ...
    public class MergeCSVFiles {
        ...
        public static void creatingMasterXlsxForAllModules() throws Exception {
            ...
            fos = new FileOutputStream(  "C:/Users/P10484475/Downloads/Master.xlsx"); // Output File after merging all excel files
            file = new File("C:/Users/P10484475/Downloads/modules");

            String[] str = file.list();
            String[] tabName = { "data" };
            for (int var = 0; var < 3; var++) {
                for (String st : str) {
                    vectorDataExcelXLSX = readDataExcelXLSX("C:/Users/P10484475/Downloads/modules/" + st, var);
        ...
        public static void main(String[] args) throws Exception {
            fileNames("C:/Users/P10484475/Downloads/modules");   // input folder where our excel files are present
